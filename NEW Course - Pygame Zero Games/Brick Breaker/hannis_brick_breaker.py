...
def draw():
    ...
    # draw game info
    screen.draw.text("Points", center = (675, 285), fontsize = 36, color = (255, 255, 255))
    screen.draw.text(str(points), center = (675, 325), fontsize = 36, color = (255, 255, 255))
...
def update():
    ...
    if power_index != -1:
        # determine which power_up was collected
