...
# [O] Assign a variable called 'ply_input' to be an empty string
# [O] Also assign a variable called 'answers' to a list containing the strings 'rock', 'paper', and 'scissors'
...
# [O] Inside this while loop, ask the player to input 'rock', 'paper', or 'scissors' and store in the 'ply_input' variable
...
while ply_input not in answers:
    ...
    ply_input = input("Enter rock, paper, or scissors >> ")
    if ply_input not in answers:
        print("Error 456. You need to input better.")
...
# [O] Use the 'cpu_num' variable to index our list 'answers' to get the computer's choice. This will make the computer pick one
...
if ply_input == "rock" and cpu_input == "rock":
    print("Tie")
elif ply_input == "rock" and cpu_input == "paper":
    print("You lose...")
elif ply_input == "..." and cpu_input == "...":
    print("...")
